...
with open('/home/yuheng/ucsb/PatchingAgent/results_temperature/location_poc_fail_nopoc2/loc_outputs.jsonl', 'r',
...
# print("has_search_result: ", has_search_result)
# print(len(has_search_result))
